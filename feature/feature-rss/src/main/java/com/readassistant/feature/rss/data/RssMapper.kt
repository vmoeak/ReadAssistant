...
fun FeedEntity.toDomain() = Feed(id = id, url = url, title = title, description = description, imageUrl = imageUrl, category = category, unreadCount = unreadCount)
fun Feed.toEntity() = FeedEntity(id = id, url = url, title = title, description = description, imageUrl = imageUrl, category = category, unreadCount = unreadCount)
